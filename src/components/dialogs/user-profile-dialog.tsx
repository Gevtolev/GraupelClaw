...
const PROFILE_KEY = projectBrand.storage.profileKey;
const THEME_KEY = projectBrand.storage.themeKey;
...
export function loadUserProfile(): UserProfile {
  ...
  try {
    const raw =
      ...
      localStorage.getItem(projectBrand.storage.legacyProfileKey);
...
export function loadThemeMode(): ThemeMode {
  ...
  return (
    ...
    (localStorage.getItem(projectBrand.storage.legacyThemeKey) as ThemeMode) ||
    "dark"
  );
}
